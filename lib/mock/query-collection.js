...
function getMockCollection(req, res, next, dataStore) {
  if (res.swagger.schema &&
      (res.swagger.schema.default || res.swagger.schema.example)) {
    util.debug('Using mock data from schema');
    var resources = res.swagger.schema.default || res.swagger.schema.example;
